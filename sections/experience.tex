...
\innerlist{
	\entry{Spearheaded a project for testing the feasibility of switching forklift trucks from legacy lead-acid batteries to Lithium-Ion batteries.}
	\entry{Designed and conducted preliminary experiments which would allow Raymond to monitor the on-field performance of the hydraulic systems in its lift trucks through telematics software already in use.}
	\entry{Modeled the mast of a forklift truck under extreme loading conditions using Abaqus, in order to investigate the effect of changing the thickness of hydraulic cylinders.}
}
